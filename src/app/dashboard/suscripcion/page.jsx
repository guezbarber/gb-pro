...
const PLANES = [
  {
    ...
    features: [
      ...
      { texto: "Equipo de barberos", incluido: false },
    ],
    cta: "Plan actual",
    ctaDisabled: true,
    mpUrl: null,
  ...
  },
  {
    ...
    features: [
      ...
      { texto: "Hasta 5 barberos", incluido: true },
      { texto: "Dashboard del equipo", incluido: true },
      { texto: "Estadísticas por barbero", incluido: true },
      { texto: "Acceso de empleados gratis", incluido: true },
      { texto: "Selector de barbero en reservas", incluido: true },
