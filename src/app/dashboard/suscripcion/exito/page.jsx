        ...
        {verificando ? (
          ...
          <>
            <div className="w-16 h-16 mx-auto bg-amber-100 rounded-full flex items-center justify-center">
              <div className="w-8 h-8 rounded-full bg-amber-300 animate-pulse" />
            </div>
            <h2 className="text-xl font-black">Pago en proceso</h2>
            <p className="text-muted-foreground text-sm">
              MercadoPago está confirmando tu pago. Puede tardar unos minutos.
            </p>
          </>
        )}
      </div>
    ...
    <div className="min-h-screen bg-muted/20 flex items-center justify-center p-4">
      <Suspense fallback={
        <div className="text-center">
          <p className="font-bold text-muted-foreground animate-pulse">Cargando...</p>
        </div>
      }>
